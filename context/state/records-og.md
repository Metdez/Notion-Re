...
- **Events** (`fd690644-d524-8205-b26c-873fba047650`): **4 rows** — CCIA Annual Meeting 2025-12-03 `81d8-86a5` · AGC CT Awards 2025-10-09 `812e-a3ac` · ENR NE Best Projects 2026 (no date — year-only) `8140-aac8` · **CMAA CT Chapter Project Achievement Awards 2025** `37d90644-d524-8175-8ede-d861642bd3e5` (created 2026-06-12, company linked, Location tags=Connecticut, Date=2025-01-01 placeholder, body sourced from LinkedIn). All linked→O&G. Location tags option added: New England. ⚠ MCP gotcha confirmed: `Place` rejects name/address-only values (needs lat/lng) — venues kept in body.
