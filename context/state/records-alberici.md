...
- 2026-06-12 audit (3rd pass — full re-audit vs Alb.md + Alb2.md, all 13 division rows including Alb2.md-sourced AWCL/Healthcare): **8 fills** — (1) WWPS division `Adress` place → 9935 Villa Rica Hwy, Villa Rica, GA 30180 (33.73, -84.962) [wwpsllc.com/about-us/]; (2) WWPS body → Founded 1997, address, Alberici Enterprise 2008; (3) Leonard Masonry division `Adress` place → Hazelwood, MO (38.768, -90.364) [leonardmasonry.com]; (4) Leonard Masonry body → Founded 1959, footprint, sectors; (5) Filanc division `Adress` place → Escondido, CA (33.119, -117.086) [alberici.com acquisition announcement]; (6) Filanc body → Leader: Omar Rodea, President + Founded 1952 + footprint + sectors; (7) Flintco body → added Leader: Steve Eikanger, President and CEO [flintco.com/steve-eikanger-promoted-to-president-of-flintco/] + expanded footprint/safety; (8) CAS Constructors body → added Leader: Travis Stryker, PE, President [casconstructors.com/about-us/] + Founded 1985 + sectors; (9) Kienlen Constructors body → added Leader: John Grib, VP Market Leader [kienlenconstructors.com] + sectors + bonding note. **Note:** Alb2.md explicitly states AGCMO Keystone 2023 venue "Not stated in source" — Place remains empty (not a fillable gap). All checks 3a–3e re-verified. Genuinely sourceless unchanged: CAGE code, EMR/TRIR, AGC TechCon + Procore Groundbreak Place (no lat/lng in either dossier). Dup-membership rows (6) still pending UI deletion by Zack.
