...
- **⚠ Middlesex membership duplicates (found 2026-06-11, notion-audit pass #3):** A prior automated audit pass (06-11 09:15) created duplicate membership rows for CCIA, DBIA-FL, and FTBA in the Memberships data source `83490644`. Original rows (`37b90644` IDs, created 06-10) are canonical and complete. Duplicates to delete in Notion UI (go to "The Middlesex Corp" profile page → Memberships table): `37c90644-d524-811f-b75a-cabc6dbee2a1` (CCIA dup) · `37c90644-d524-81a1-87ab-e21eb5cbd97b` (DBIA-FL dup) · `37c90644-d524-8147-91f5-d5b390684612` (FTBA dup). ABC row has no duplicate. **Deletion = destructive, explicit OK needed from Zack.**
