# Batch 16 — records 37501–40000 (2500 total)
...
| Source folder | `batch-16/` |
| Records | 0 / 2500 |

## Files
- [ ] `records-37501-38000.csv` — 0/500 — cursor: row 0 — `pending`
- [ ] `records-38001-38500.csv` — 0/500 — cursor: row 0 — `pending`
- [ ] `records-38501-39000.csv` — 0/500 — cursor: row 0 — `pending`
- [ ] `records-39001-39500.csv` — 0/500 — cursor: row 0 — `pending`
- [ ] `records-39501-40000.csv` — 0/500 — cursor: row 0 — `pending`

## Resume cursor
- Last imported: **none**
- Next up: file `records-37501-38000.csv`, row **1**
