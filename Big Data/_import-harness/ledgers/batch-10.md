# Batch 10 — records 22501–25000 (2500 total)
...
| Source folder | `batch-10/` |
| Records | 0 / 2500 |

## Files
- [ ] `records-22501-23000.csv` — 0/500 — cursor: row 0 — `pending`
- [ ] `records-23001-23500.csv` — 0/500 — cursor: row 0 — `pending`
- [ ] `records-23501-24000.csv` — 0/500 — cursor: row 0 — `pending`
- [ ] `records-24001-24500.csv` — 0/500 — cursor: row 0 — `pending`
- [ ] `records-24501-25000.csv` — 0/500 — cursor: row 0 — `pending`

## Resume cursor
- Last imported: **none**
- Next up: file `records-22501-23000.csv`, row **1**
