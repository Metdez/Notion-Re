# Batch 05 — records 10001–12500 (2500 total)
...
| Source folder | `batch-05/` |
| Records | 0 / 2500 |

## Files
- [ ] `records-10001-10500.csv` — 0/500 — cursor: row 0 — `pending`
- [ ] `records-10501-11000.csv` — 0/500 — cursor: row 0 — `pending`
- [ ] `records-11001-11500.csv` — 0/500 — cursor: row 0 — `pending`
- [ ] `records-11501-12000.csv` — 0/500 — cursor: row 0 — `pending`
- [ ] `records-12001-12500.csv` — 0/500 — cursor: row 0 — `pending`

## Resume cursor
- Last imported: **none**
- Next up: file `records-10001-10500.csv`, row **1**
